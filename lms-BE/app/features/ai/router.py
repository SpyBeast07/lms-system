...
# --- Teacher Endpoints ---
@router.post("/course-content", response_model=AIResponse, dependencies=[Depends(require_role("teacher", "super_admin")), Depends(validate_school_subscription)])
...
@router.post("/assignment-instructions", response_model=AIResponse, dependencies=[Depends(require_role("teacher", "super_admin")), Depends(validate_school_subscription)])
...
# --- Student Endpoints ---
@router.post("/summarize-notes", response_model=AIResponse, dependencies=[Depends(require_role("student", "teacher", "super_admin")), Depends(validate_school_subscription)])
...
@router.post("/explain-topic", response_model=AIResponse, dependencies=[Depends(require_role("student", "teacher", "super_admin")), Depends(validate_school_subscription)])
...
@router.post("/practice-questions", response_model=AIResponse, dependencies=[Depends(require_role("student", "teacher", "super_admin")), Depends(validate_school_subscription)])
...
@router.post("/generate", response_model=AIResponse, dependencies=[Depends(get_current_user), Depends(validate_school_subscription)])
